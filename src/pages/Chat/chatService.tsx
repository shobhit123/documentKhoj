...
export const handleSearch = async (
  ...
  try {
    ...
    const response = {
      ...
      content: `Acknowledge the loss. Request the customer for his father’s account details and any documents related to his death?`,
      metadata: [
        {
          page_no: 1,
          topic: "Death Claim",
          sub_topic: "Nomination Process",
          section: "Customer Claim",
          doc_url: "https://www.rbi.org.in/guidelines/AadharAuthentication",
          source: "Nomination and Death Claim Circular_2024.pdf"
        },
      ],
    };
    if (response) {
